    ...
    <div class="pz-container">
        ...
        <form action="{{ route('properties_store') }}" method="POST" enctype="multipart/form-data" id="form"
            ...
            <div class="pz-form-group">
                ...
                <div>
                    <textarea name="description" id="description" rows="3" required class="pz-textarea"
                ...
                <div class="pz-form-group">
                    ...
                    <div>
                        <input type="number" name="floors" id="floors" min="1" step="1" required
                            max="50" maxlength="2" class="pz-input" />
                        @error('floors')
                            <p class="pz-error">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="pz-form-group">
                    ...
                    <div>
                        <input type="number" name="current_floor" id="current_floor" min="1" step="1"
                            max="50" maxlength="2" required class="pz-input" />
                        @error('current_floor')
                            <p class="pz-error">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="pz-form-group">
                    ...
                    <div>
                        <input type="number" name="rent_price" id="rent_price" min="0" step="0.01"
                            placeholder="0.00" required class="pz-input" value="{{ old('rent_price') }}" />
                        @error('rent_price')
                            <p class="pz-error">{{ $message }}</p>
                        @enderror
                    </div>
